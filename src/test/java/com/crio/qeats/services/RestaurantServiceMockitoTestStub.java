...
public class RestaurantServiceMockitoTestStub {
  ...
  public void initializeRestaurantObjects() throws IOException {
    ...
    Restaurant[] restaurants =
        objectMapper.readValue(fixture, Restaurant[].class);
  ...
  public void testFindNearbyWithin5km() throws IOException {
    ...
    GetRestaurantsResponse allRestaurantsCloseBy =
        restaurantService.findAllRestaurantsCloseBy(
            new GetRestaurantsRequest(20.0, 30.0),
            LocalTime.of(3, 0)
        );
    ...
    assertEquals(
        "11",
        allRestaurantsCloseBy.getRestaurants().get(0).getRestaurantId()
    );

    assertEquals(
        "12",
        allRestaurantsCloseBy.getRestaurants().get(1).getRestaurantId()
    );

    ArgumentCaptor<Double> servingRadiusInKms =
    ...
    assertEquals(Double.valueOf(5.0), servingRadiusInKms.getValue());
  }
  ...
  public void testFindNearbyWithin3km() throws IOException {
    ...
    List<Restaurant> restaurantList1 =
        Arrays.asList(restaurant1, restaurant4);

    List<Restaurant> restaurantList2 =
        Arrays.asList(restaurant2, restaurant4);
    ...
    assertEquals(
        2,
        allRestaurantsCloseByOffPeakHours.getRestaurants().size()
    );

    assertEquals(
        "11",
        allRestaurantsCloseByOffPeakHours
            .getRestaurants()
            .get(0)
            .getRestaurantId()
    );
    ...
    assertEquals(
        2,
        allRestaurantsCloseByPeakHours.getRestaurants().size()
    );

    assertEquals(
        "12",
        allRestaurantsCloseByPeakHours
            .getRestaurants()
            .get(0)
            .getRestaurantId()
    );
